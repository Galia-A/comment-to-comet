    ...
    <div className={`${styles.contentAligned} ${styles.wideBorder}`}>
      ...
      <div className={styles.text}>
        <li className={styles.list}>
          הנתונים יעשו לצורכי הקורס בלבד ולא יאפשרו את זיהוי המשתתפות.ים.
        </li>
        <li className={styles.list}>
          הנתונית הגולמיים ישמרו בקבצי מחשב שהגישה אליהם תוגבל באמצעות סיסמה.
        </li>
        <li className={styles.list}>
          לא יפגעו מי שיבקשו להפסיק את ההשתפות ולהסיר את פרטיהן.ם.
        </li>
      </div>
      <div className={styles.text}>
      ...
      <div className={styles.text}>
        ...
        <br />
        אין אפשרות להפסיק את התהליך באמצע והוא ייקח קצת זמן (כ-10 דקות) אז בבקשה
        אל תסגרו את הדפדפן וענו כמיטב יכולתכן.ם.
      </div>
