  ...
  return (
    <div className={`${styles.contentAligned} ${styles.wideBorder}`}>
      <div className={styles.contentHeadline}>
        <ReadAloud sndNumber={0} /> &nbsp; החלל מחכה ואני שמחה להכיר!
      </div>
      <div className={styles.text}>
        אני גליה אפל, אני עובדת בעמותת תפוח. במסגרת הלימודים שלי בתואר שני
        לטכנולוגיות למידה בסמינר הקיבוצים, אני מבצעת מחקר בקורס "סדנת-גמר".
        המחקר עוסק בלימוד והוראת מקצועות ה -STEM (Science, technology,
        engineering, and mathematics) ובאופן ספציפי בלימוד תכנות ומקצועות החלל.
      </div>
      <div className={styles.text}>
      ...
      <div className={styles.text}>
        אם בחרתן.ם להשתתף במחקר, בבקשה ענו בצורה מפורטת ככל האפשר על השאלונים.
      ...
      <div className={styles.text}>
        ...
        <br />
        לאחר שעניתן.ם על השאלות יתחיל הפרק הראשון של הקורס, ובסופו תחזרו
        לשאלונים שמלאתן.ם בהתחלה. מילוי של השאלונים בהתחלה ובסוף יאפשר לי ללמוד
        מה אתן.ם למדתן.ם.
      </div>
