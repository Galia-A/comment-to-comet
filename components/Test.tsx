      ...
      <form onSubmit={handleSubmit}>
        <FormControl>
          ...
          >
            ...
            צריך להתבצע בקרוב. בגלל שלוקח לכל הודעה 15 דקות להגיעה לחללית (ועוד
            15 דקות חזרה) נרצה להכין הודעה קולית מפורטת ככל האפשר.
            <div className={styles.questionDetails}>
              <ul>
                ידוע לנו ש:
                <li>
                ...
                <li>
                  איש צוות צריך להיות מוכן לעזור האסטרונאוטים שיוצאים ללבוש את
